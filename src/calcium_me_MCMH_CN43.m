    ...
    for session_it = 1:nsessions(2)
        ...
        for day = [1,2,3,4]
            ...
            if number_of_cells_flag == 1
                ...
                subplot(2,3,2)
                title(strcat('Heat Capacity Mouse:', mouse, ' session:', session, ' day:', int2str(day)))
                figure_name = strcat(figures_dir, 'heat_capacity_mouse_',mouse,'_session_',session,'_trial_',trial_id,'_v1.4.20.3.0.1.1.0_ncells_',int2str(ncells),'.png');
